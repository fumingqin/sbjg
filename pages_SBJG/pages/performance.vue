	...
	export default {
		...
		methods: {
			loadData(company, type) {
				...
				console.log(type, '2');
				uni.request({
					url: this.$Sbjg.SbjgInterface.GetPerformance.Url,
					method: this.$Sbjg.SbjgInterface.GetPerformance.method,
					header: this.$Sbjg.SbjgInterface.GetPerformance.header,
					data: {
						company: company,
						type: type,
						sdate:this.sDate,
